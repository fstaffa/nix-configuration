...
in
{
  ...
  programs.aws = {
    ...
    accounts = {
      planning = {
        ...
        hosts = {
          gitlab-runner-labe = "i-078ae4fcfd4fa9dff";
        };
      };
    };
  };
  ...
  programs.git.includes = [
    {
      ...
      contents = {
        user = {
          name = "Filip Staffa";
          email = builtins.concatStringsSep "s" [
            "f"
            "taffa@cimpre"
            ""
            ".com"
  ...
  projects = {
    ...
    projects = {
      bastion-labe = {
        repository = {
          repositoryUrl = "git@gitlab.com:Cimpress-Technology/fulfillment/logistics/logistics-v1/labe/infrastructure/bastion.git";
          folder = "bastion-labe";
        };
      };
      logistics-microservices-alignment = {
        repository = {
          repositoryUrl = "git@gitlab.com:Cimpress-Technology/fulfillment/logistics/initiatives/engineering-alignment/microservices.git";
          folder = "logistics-microservices-alignment";
        };
      };
      calendars-ui = {
        repository = {
          repositoryUrl = "git@gitlab.com:Cimpress-Technology/fulfillment/logistics/logistics-v1/labe/calendars-ui.git";
          folder = "calendars-ui";
        };
      };
      ccm = {
        type = "planning";
        repository = {
          repositoryUrl = "git@gitlab.com:Cimpress-Technology/fulfillment/logistics/logistics-v1/labe/ccm-next.git";
          folder = "ccm";
        };
        rds = {
          basePort = 15432;
          prd = {
            host = "ccm-prd.caweq0ojnzgj.eu-west-1.rds.amazonaws.com";
          };
          stg = {
            host = "ccm-stg.caweq0ojnzgj.eu-west-1.rds.amazonaws.com";
          };
        };
      };
      calendars = {
      ...
      picky = {
        repository = {
          repositoryUrl = "git@gitlab.com:Cimpress-Technology/fulfillment/logistics/logistics-v1/labe/pickups-aggregation-service.git";
          folder = "picky";
        };
      };
      planning-api = {
        repository = {
          repositoryUrl = "git@gitlab.com:Cimpress-Technology/fulfillment/logistics/logistics-v1/labe/planning-api-service.git";
          folder = "planning-api";
        };
      };
      planning-event-processor = {
        repository = {
          repositoryUrl = "git@gitlab.com:Cimpress-Technology/fulfillment/logistics/logistics-v1/labe/planning-event-processor.git";
        ...
        rds = {
          basePort = 55432;
          prd = {
            host = "pep-prd.caweq0ojnzgj.eu-west-1.rds.amazonaws.com";
          };
          stg = {
            host = "pep-stg.caweq0ojnzgj.eu-west-1.rds.amazonaws.com";
          };
        };
      };
      quoter-publisher = {
      ...
      renovate-test-project-nodejs = {
        repository = {
          repositoryUrl = "git@gitlab.com:Cimpress-Technology/fulfillment/logistics/logistics-v1/labe/renovate-test-project-nodejs.git";
          folder = "renovate-test-project-nodejs";
        };
      };
      renovate-test-project-dotnet = {
        repository = {
          repositoryUrl = "git@gitlab.com:Cimpress-Technology/fulfillment/logistics/logistics-v1/labe/renovate-test-project-dotnet.git";
      ...
      packer-config = {
        repository = {
          repositoryUrl = "git@gitlab.com:Cimpress-Technology/fulfillment/logistics/logistics-v1/labe/packer-config-service.git";
        ...
        rds = {
          basePort = 35432;
          prd = {
            host = "packer-config-production.caweq0ojnzgj.eu-west-1.rds.amazonaws.com";
          };
          stg = {
            host = "packer-config-staging.caweq0ojnzgj.eu-west-1.rds.amazonaws.com";
          };
        };
      };
      packer-ui = {
        repository = {
          repositoryUrl = "git@gitlab.com:Cimpress-Technology/fulfillment/logistics/logistics-v1/praguematic/packer-ui.git";
          folder = "packer-ui";
        };
      };
      roadmap = {
        repository = {
          repositoryUrl = "git@gitlab.com:Cimpress-Technology/fulfillment/logistics/logistics-v1/labe/roadmap.git";
          folder = "roadmap";
        };
      };
      exchange-rates = {
        repository = {
          repositoryUrl = "git@gitlab.com:Cimpress-Technology/fulfillment/logistics/logistics-v1/labe/exchange-rates.git";
      ...
      boxman-service = {
        ...
        rds = {
          basePort = 45432;
          prd = {
            host = "db-boxman-production.ckibexf9dpta.eu-west-1.rds.amazonaws.com";
          };
          stg = {
      ...
      boxman-ui = {
        repository = {
          repositoryUrl = "git@gitlab.com:Cimpress-Technology/fulfillment/logistics/logistics-v1/praguematic/boxman-ui.git";
          folder = "boxman-ui";
        };
      };
      ci-tools = {
        repository = {
          repositoryUrl = "git@gitlab.com:Cimpress-Technology/fulfillment/logistics/logistics-v1/praguematic/ci-tools.git";
          folder = "ci-tools";
        };
      };
      ci-cd-components = {
        repository = {
          repositoryUrl = "git@gitlab.com:Cimpress-Technology/fulfillment/logistics/logistics-v1/labe/infrastructure/ci-cd-components.git";
          folder = "ci-cd-components";
        };
      };
      dojo-ts-template = {
        repository = {
          repositoryUrl = "git@gitlab.com:Cimpress-Technology/fulfillment/logistics/logistics-v1/labe/dojo/dojo-ts-template.git";
          folder = "dojo-ts-template";
        };
      };
      dojo-cs-template = {
        repository = {
          repositoryUrl = "git@gitlab.com:Cimpress-Technology/fulfillment/logistics/logistics-v1/labe/dojo/csharp-template.git";
          folder = "dojo-cs-template";
        };
      };
      gitlab-configuration = {
        repository = {
          repositoryUrl = "git@gitlab.com:Cimpress-Technology/fulfillment/logistics/logistics-v1/labe/infrastructure/gitlab-configuration.git";
      ...
      react-platform-components = {
        repository = {
          repositoryUrl = "git@gitlab.com:Cimpress-Technology/internal-open-source/component-library/react-platform-components.git";
          folder = "react-platform-components";
        };
      };
      documentation = {
        repository = {
          repositoryUrl = "git@gitlab.com:Cimpress-Technology/fulfillment/logistics/logistics-v1/labe/documentation.git";
          folder = "documentation";
        };
      };
      security-documentation = {
        repository = {
          repositoryUrl = "git@gitlab.com:Cimpress-Technology/fulfillment/logistics/security/documentation.git";
          folder = "security-documentation";
        };
      };
      shiprec-ui = {
        repository = {
          repositoryUrl = "git@gitlab.com:Cimpress-Technology/fulfillment/logistics/logistics-v1/praguematic/shiprec-ui.git";
          folder = "shiprec-ui";
        };
      };
      ...
      bruno-collections = {
        repository = {
          repositoryUrl = "git@gitlab.com:Cimpress-Technology/fulfillment/logistics/logistics-v1/labe/bruno-collection.git";
